        ...
        <section>
          <div className="grid grid-cols-2 divide-x divide-border border-y border-border">
            <div className="flex flex-col items-center gap-2 py-10 text-center">
              <div className={`text-6xl font-bold leading-none tabular-nums tracking-tight ${dueCount > 0 ? 'text-warning' : 'text-foreground/30'}`}>
                {dueCount}
              </div>
            ...
            <div className="flex flex-col items-center gap-2 py-10 text-center">
              <div className={`text-6xl font-bold leading-none tabular-nums tracking-tight ${newCount > 0 ? 'text-primary' : 'text-foreground/30'}`}>
                {newCount}
              </div>
              <div className="text-xs text-muted-foreground">
                题待学习
